class LoadData < ActiveRecord::Migration
  def up
    ...
    comment = Comment.new(:date_time => "2012-09-02 14:01:00",
                          :comment => "Learning a new programming languages is hard...")
    comment.user = jo
    ...
    comment = Comment.new(:date_time => "2013-11-28 17:45:13",
                          :comment => "I came up with lots of comments for this photo, " +
                              "but unfortunately none of them were good.")
    comment.user = jo
    ...
    comment.save(:validate => false)
    comment = Comment.new(:date_time => "2013-11-02 14:07:00",
                          :comment => "Sure, let's get together when Lindsay gets home " +
                              "and I get healthcare.gov working.")
    comment.user = bo
    comment.photo = photo7
    comment.save(:validate => false)
